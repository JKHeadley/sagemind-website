...
export default function Footer() {
  ...
  if (pathname?.startsWith("/for-gregg")) return null;

  return (
    <footer className="bg-near-black border-t border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-gray-400 hover:text-bright-cyan transition-colors"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div className="md:col-span-3">
            ...
            <ul className="space-y-4">
              {[
                { label: "Custom Websites", href: "/services#small-business" },
                { label: "Google Workspace Solutions", href: "/services#small-business" },
                { label: "AI Applications", href: "/services#ai-solutions" },
                { label: "Data Solutions", href: "/services#ai-solutions" },
              ].map((service) => (
        ...
        <div className="border-t border-white/5 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-500 text-sm">
            &copy; {new Date().getFullYear()} SageMind AI LLC. All rights reserved.
          </p>
          <p className="text-gray-500 text-sm">
